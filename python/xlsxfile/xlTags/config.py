...
valid_types = ['BINARY','TANK_LEVEL','PIPE_PSIA','PIPE_PSIG','TEMP_F','FLOW_RATE','PERCENT','DURATION',
            'VOLUME','VOLTAGE','VOLTS','SETPOINT','ACTUATOR','AMPS','CONTROLLER_STATE','COUNTER',
